...
`@script`
Finally, we should test inputs that raise Exceptions. In this case, any input that is not a positive integer should raise a ValueError. Examples would be be a float like 2.3 or a list containing integers.
